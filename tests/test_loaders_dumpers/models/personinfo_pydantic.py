...
linkml_meta = LinkMLMeta(
    {
        "classes": {
            ...
            "FamilialRelationship": {
                ...
                "slot_usage": {
                    "related_to": {"name": "related_to", "range": "Person", "required": True},
                    "type": {"name": "type", "range": "FamilialRelationshipType", "required": True},
                },
            },
            "HasAliases": {
                "attributes": {
        ...
        "enums": {
            "DiagnosisType": {"from_schema": "https://w3id.org/linkml/examples/personinfo", "name": "DiagnosisType"},
            "FamilialRelationshipType": {
                "from_schema": "https://w3id.org/linkml/examples/personinfo",
                "name": "FamilialRelationshipType",
                "permissible_values": {
                    "CHILD_OF": {"meaning": "famrel:03", "text": "CHILD_OF"},
                    "PARENT_OF": {"meaning": "famrel:02", "text": "PARENT_OF"},
                    "SIBLING_OF": {"meaning": "famrel:01", "text": "SIBLING_OF"},
                },
            },
            "GenderType": {
                "from_schema": "https://w3id.org/linkml/examples/personinfo",
                "name": "GenderType",
                "permissible_values": {
                    "cisgender man": {"meaning": "GSSO:000371", "text": "cisgender man"},
                    "cisgender woman": {"meaning": "GSSO:000385", "text": "cisgender woman"},
                    "nonbinary man": {"meaning": "GSSO:009254", "text": "nonbinary man"},
                    "nonbinary woman": {"meaning": "GSSO:009253", "text": "nonbinary woman"},
                    "transgender man": {"meaning": "GSSO:000372", "text": "transgender man"},
                    "transgender woman": {"meaning": "GSSO:000384", "text": "transgender woman"},
                },
            },
        },
        ...
        "name": "personinfo",
        "prefixes": {
            "CODE": {"prefix_prefix": "CODE", "prefix_reference": "http://example.org/code/"},
            "GEO": {"prefix_prefix": "GEO", "prefix_reference": "http://example.org/geoloc/"},
            "GSSO": {"prefix_prefix": "GSSO", "prefix_reference": "http://purl.obolibrary.org/obo/GSSO_"},
            "P": {"prefix_prefix": "P", "prefix_reference": "http://example.org/P/"},
            "ROR": {"prefix_prefix": "ROR", "prefix_reference": "http://example.org/ror/"},
            "famrel": {"prefix_prefix": "famrel", "prefix_reference": "https://example.org/FamilialRelations#"},
...
class Person(HasAliases, NamedThing):
    ...
    has_employment_history: Optional[list[EmploymentEvent]] = Field(
        default=None,
        json_schema_extra={
            "linkml_meta": {
    ...
    has_familial_relationships: Optional[list[FamilialRelationship]] = Field(
        default=None,
        json_schema_extra={
            "linkml_meta": {
    ...
    has_medical_history: Optional[list[MedicalEvent]] = Field(
        default=None,
        json_schema_extra={
            "linkml_meta": {
...
class Organization(HasAliases, NamedThing):
    ...
    founding_location: Optional[str] = Field(
        default=None,
        json_schema_extra={
            "linkml_meta": {
                "alias": "founding_location",
                "domain_of": ["Organization"],
                "from_schema": "https://w3id.org/linkml/examples/personinfo",
                "name": "founding_location",
                "owner": "Organization",
...
class Event(ConfiguredBaseModel):
    ...
    ended_at_time: Optional[date] = Field(
        default=None,
        json_schema_extra={
            "linkml_meta": {
                "alias": "ended_at_time",
...
class Concept(NamedThing):
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {"from_schema": "https://w3id.org/linkml/examples/personinfo", "is_a": "NamedThing", "name": "Concept"}
    )
...
class DiagnosisConcept(Concept):
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {"from_schema": "https://w3id.org/linkml/examples/personinfo", "is_a": "Concept", "name": "DiagnosisConcept"}
    )
...
class ProcedureConcept(Concept):
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {"from_schema": "https://w3id.org/linkml/examples/personinfo", "is_a": "Concept", "name": "ProcedureConcept"}
    )
...
class EmploymentEvent(Event):
    ...
    employed_at: Optional[str] = Field(
        default=None,
        json_schema_extra={
            "linkml_meta": {
                "alias": "employed_at",
...
class MedicalEvent(Event):
    ...
    diagnosis: Optional[DiagnosisConcept] = Field(
        default=None,
        json_schema_extra={
            "linkml_meta": {
                "alias": "diagnosis",
    ...
    procedure: Optional[ProcedureConcept] = Field(
        default=None,
        json_schema_extra={
            "linkml_meta": {
                "alias": "procedure",
...
class Container(ConfiguredBaseModel):
    ...
    persons: Optional[list[Person]] = Field(
        default=None,
        json_schema_extra={
            "linkml_meta": {
                "alias": "persons",
